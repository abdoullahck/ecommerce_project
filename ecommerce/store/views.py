...
def product_detail(request, slug):
    ...
    produit_en_relation = Product.objects.filter(category=category)[:5]
    context = {'items': items, 'order': order, 'cartItems': cartItems, 'product': product, 'produit_en_relation':produit_en_relation}
